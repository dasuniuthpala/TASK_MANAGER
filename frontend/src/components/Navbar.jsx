...
const Navbar = ({ user = {}, onLogout, children }) => {
        ...
        <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
          ...
          <div className='flex items-center gap-4'>
            ...
            <div ref={menuRef} className="relative">
              <div className="flex items-center gap-2 px-3 py-2 rounded-full border border-transparent hover:border-purple-200">
                ...
                <button
                  ...
                  className={`ml-2 p-1 rounded-full hover:bg-gray-100 transition ${menuOpen ? 'bg-gray-100' : ''}`}
                >
              ...
              {/* Dropdown */}
              {menuOpen && (
                <ul className="absolute top-12 right-0 w-48 bg-white rounded-lg shadow-lg border border-gray-100 z-50 mt-2 animate-fadeIn">
                  <li className="p-2">
                    <button
                      onClick={() => {
                        setMenuOpen(false);
                      ...
                      className="w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 rounded-md flex items-center gap-2"
                    >
                  ...
                  <li className="p-2">
                    <button
                      ...
                      className="w-full px-4 py-2 text-left text-sm text-red-600 hover:bg-red-50 rounded-md flex items-center gap-2"
                    >
